...
SECRET_KEY = 'django-insecure-a@@jz=fe_ljwv%bv!9jlg1sjl1t2=-245qfnwgd%*5(h#4sxzq'
...
WSGI_APPLICATION = 'mpesa_clone.wsgi.application'
...
# Celery Configuration (for async tasks like SMS)
...
# SMS Gateway Configuration (example - adjust based on your provider)
SMS_GATEWAY = {
